      ...
      {resultVisible && (
        <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', lineHeight: 1.5, mb: 8}}>
          ...
          <Box sx={{display: 'flex', justifyContent: 'center', mt: 7}}>
            <Button variant="contained" onClick={onModalOpen} sx={{backgroundColor: '#FCEE21', color: '#5B2386'}}>훈련하러 가기💻</Button>
            <Button variant="outlined" onClick={onShare} sx={{backgroundColor: '#fff', color: '#5B2386'}}>공유하기</Button>
          </Box>
        </Box>
      )}
    </>
